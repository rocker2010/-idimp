 ...
 $(document).ready(function() {
 	...
 	var liPlace=$(window).width()-73;
 	$("#navItem li").css("left",liPlace);
 	$(".nav1").click(function() {
...
// 			$("#navItem").css("bottom",0-$("#navItem").height());
    ...
    function movItem(itemid) {
    	var itemNum=$("#"+itemid+" li").length;
    	for(var m=0;m<itemNum;m++){ $("#"+itemid+" li").eq(m).animate({ left: 0 }, 1800-m*100); }
 	}
    
    function hideItem(itemid) {
    	var itemNum=$("#"+itemid+" li").length;
    	for(var m=0;m<itemNum;m++){ $("#"+itemid+" li").eq(m).animate({ left: $(window).width()-73}, 100+m*150); }
 	}
